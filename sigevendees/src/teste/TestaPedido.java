...
// ABAIXO ESTA O TESTE DA CLASSE PEDIDO;
		...
		// Identifica o 1º produto solicitado;
		Produto produto = new Produto();
		produto.setCodigo(1);
		produto.setDescricao("Bolo de morango");
		// Cria a chave primaria composta do 1º item do pedido;
